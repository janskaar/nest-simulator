...
const Name s_NMDA_clamp( "s_NMDA_clamp" );
const Name s_NMDA_pre_clamp_value( "s_NMDA_pre_clamp_value" );
const Name s_NMDA_post_clamp_value( "s_NMDA_post_clamp_value" );

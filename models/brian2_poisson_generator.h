...
The ``brian2_poisson_generator`` simulates a neuron that is firing with Poisson
...
``parrot_neuron`` between the brian2_poisson generator and the targets.
...
brian2_poisson_generator_ps

Examples using this model
+++++++++++++++++++++++++

.. listexamples:: brian2_poisson_generator

EndUserDocs */

void register_brian2_poisson_generator( const std::string& name );

class brian2_poisson_generator : public StimulationDevice
{
...
public:
   ...
   */
  brian2_poisson_generator();
  brian2_poisson_generator( brian2_poisson_generator const& );
...
inline size_t
brian2_poisson_generator::send_test_event( Node& target, size_t receptor_type, synindex syn_id, bool dummy_target )
{
...
inline void
brian2_poisson_generator::get_status( DictionaryDatum& d ) const
{
  P_.get( d );
...
inline void
brian2_poisson_generator::set_status( const DictionaryDatum& d )
{
...
brian2_poisson_generator::get_type() const
{
